...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.objects = [this.plane, this.pyramid, this.cone, this.tangram, this.cube, this.triangle, this.prism, this.cylinder];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Plane': 0 , 'Pyramid': 1, 'Cone': 2, 'Tangram': 3, 'Cube': 4, 'Triangle': 5, 'Prism': 6, 'Cylinder': 7};
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.71, 0.40, 0.26, 1.0); 
